...
DROP TABLE IF EXISTS verification_code_candidates;
DROP TABLE IF EXISTS verification_code_employers;
DROP TABLE IF EXISTS employee_confirms;
DROP TABLE IF EXISTS employee_confirms_employers;
